...
class DataMerger:
    ...
    def publish(self):
        colors = {"red": (0,0,255), "dark_blue": (139,0,0), "light_blue": (232,219,164), "green": (0,255,0),
                    "yellow": (0, 255, 255), "orange": (0, 165, 255), "violet": (182,38,155), "white": (255,255,255)}
        while True:
            if self.cimage is not None:
                ...
                if self.user_pose is not None:
                    cv2.putText(cimage, '+', (int(self.user_pose.x), int(self.user_pose.y)), cv2.FONT_ITALIC, 1, (0,0,0), 2, cv2.LINE_8)
