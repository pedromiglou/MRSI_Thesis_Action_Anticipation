...
\Title{\selectlanguage{portuguese}Antecipação de Ações pelo Robô em Tarefas de Montagem Colaborativa }
...
%% MAX 70 CHARACTERS
\Title{\selectlanguage{english}Robot Action Anticipation for Collaborative Assembly Tasks }
...
\Supervisor{Filipe Silva}{associado}
...
\SecondSupervisor{Vítor Santos}{auxiliar convidado}{do Departamento de Matemática}{da Universidade de Aveiro}
