...
class SavePointsCSV:
    ...
    def __init__(self, output_folder):
        ...
        self.filename_sub = rospy.Subscriber("csv_filename", String, self.csv_filename_callback)

    def csv_filename_callback(self, msg):
        self.file_path = self.output_folder + msg.data + ".csv"
