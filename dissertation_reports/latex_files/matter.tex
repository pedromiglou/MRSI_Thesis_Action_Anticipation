...
% altered from: \usepackage[backend=biber,style=ieee, sorting=none]{biblatex}
...
%\sisetup{load-configurations = binary} % no longer valid
...
\include{chapters/experimental_infrastructure}
\include{chapters/proposed_solution}
\include{chapters/test_and_results}
