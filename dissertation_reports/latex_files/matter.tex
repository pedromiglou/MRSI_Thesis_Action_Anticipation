...
% Redefine section names according to your preference (uncommented, not changed)
\addto\extrasenglish{  % added this line
...
\bibliography{bib/myrefs, bib/article_refs}
...
\usetikzlibrary{arrows,shadows,trees,shapes,decorations,automata,backgrounds,petri,mindmap,positioning} % for pgf-umlsd

% Package to master SI units
\usepackage[detect-weight=true, %binary-units=true
]{siunitx}
...
\include{chapters/chapter2_state_of_the_art}
\include{chapters/chapter3_hrc_system}
\include{chapters/chapter4_learning}
